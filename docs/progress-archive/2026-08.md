...
- **2026-08-22 (session 15, Claude Opus): M8 built AND SIGNED OFF — assemble,
  ...
  **Did:** `examples/10-open-world`; render interpolation; ADR 0044 (graphics
  ...
  and `docs/api/`; `docs/migrating.md` written for real; `@luaug/camera`;
...
- **E1 — The Editor — COMPLETE, signed off 2026-08-22**, tagged `milestone/e1`. Post-v1 phase 1,
  ...
  **What it does not have** is in full at the end of the brief; E2 owns the
  ...
  that is a stop that restores the world and not the Luau VM. **Answered by ADR 0058** (2026-08-24): play starts the scripts and stop tears the runtime down, so a second play is the same as the first -- taken up because the editor was also RUNNING every entry script's file scope at boot (D092), and the VM's lifetime turned out to be the other half of that. **ADR 0047's boot
...
## E4's state summary, moved out of PROGRESS.md when E6 was written up
...
## E8's, E7's, E6's and E5's state summaries, moved out of PROGRESS.md on 2026-08-26
...
## Session log entries 21 through 25, moved out of PROGRESS.md on 2026-08-26
...
## The phase-1 State bullets, as PROGRESS carried them until 2026-09-22
