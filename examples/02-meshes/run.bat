...
REM
REM It also carries content/: `asset://models/scene.gltf` resolves against THIS
REM project's content directory rather than the engine's, so the mesh only
REM loads when the host is given the project root.
REM
