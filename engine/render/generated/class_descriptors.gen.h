...
bool setLightingEnvironmentSpecularScale(scene::World& world, core::InstanceId id, const scene::Value& value);
scene::Value getLightingShadowSoftness(const scene::World& world, core::InstanceId id);
bool setLightingShadowSoftness(scene::World& world, core::InstanceId id, const scene::Value& value);
scene::Value getLightingGlobalShadows(const scene::World& world, core::InstanceId id);
bool setLightingGlobalShadows(scene::World& world, core::InstanceId id, const scene::Value& value);
scene::Value getLightingAutoExposure(const scene::World& world, core::InstanceId id);
bool setLightingAutoExposure(scene::World& world, core::InstanceId id, const scene::Value& value);
