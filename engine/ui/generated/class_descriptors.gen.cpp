...
void registerClasses(scene::ClassRegistry& classes, core::AtomTable& atoms)
{
    ...
    textLabelProperties = {{
        ...
        scene::PropertyDesc{
            .name = atoms.intern("TextXAlignment"),
            .type = scene::ValueType::EnumItem,
            .enumName = atoms.intern("HorizontalAlignment"),
            .threadSafety = scene::ThreadSafety::Unsafe,
            .readOnly = false,
            .inert = false,
            .doc = "Where the text sits across the box: `Left`, `Center` or `Right`. Named for the text, because a layout's `HorizontalAlignment` places children and this places words; the values are the same enum a layout uses.",
            .errKeyOnInvalidSet = LUAUG_TR("scene.err.expected_enum_item"),
            .get = native::getTextLabelTextXAlignment,
            .set = native::setTextLabelTextXAlignment,
        },
        scene::PropertyDesc{
            .name = atoms.intern("TextYAlignment"),
            .type = scene::ValueType::EnumItem,
            .enumName = atoms.intern("VerticalAlignment"),
            .threadSafety = scene::ThreadSafety::Unsafe,
            .readOnly = false,
            .inert = false,
            .doc = "Where the text sits down the box: `Top`, `Center` or `Bottom`.",
            .errKeyOnInvalidSet = LUAUG_TR("scene.err.expected_enum_item"),
            .get = native::getTextLabelTextYAlignment,
            .set = native::setTextLabelTextYAlignment,
        },
        scene::PropertyDesc{
