...
[[nodiscard]] inline SDL_GPUTextureFormat toSdl(TextureFormat format) noexcept
{
    switch (format)
    {
    case TextureFormat::Undefined: return SDL_GPU_TEXTUREFORMAT_INVALID;
    ...
    case TextureFormat::Rgba32Float: return SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT;
    case TextureFormat::D16Unorm: return SDL_GPU_TEXTUREFORMAT_D16_UNORM;
    ...
    case TextureFormat::D32FloatS8Uint: return SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT;
    case TextureFormat::Bc1RgbaUnorm: return SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM;
    case TextureFormat::Bc3RgbaUnorm: return SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM;
    case TextureFormat::Bc5RgUnorm: return SDL_GPU_TEXTUREFORMAT_BC5_RG_UNORM;
    case TextureFormat::Bc7RgbaUnorm: return SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM;
    }
...
[[nodiscard]] inline TextureFormat fromSdl(SDL_GPUTextureFormat format) noexcept
{
    ...
    case SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT: return TextureFormat::Rgba16Float;
...
[[nodiscard]] inline SDL_GPUShaderFormat toSdl(ShaderFormat format) noexcept
{
    switch (format)
    {
    case ShaderFormat::Unknown: return SDL_GPU_SHADERFORMAT_INVALID;
...
[[nodiscard]] inline SDL_GPUIndexElementSize toSdl(IndexType type) noexcept
{
    switch (type)
    {
    case IndexType::U16: return SDL_GPU_INDEXELEMENTSIZE_16BIT;
    case IndexType::U32: return SDL_GPU_INDEXELEMENTSIZE_32BIT;
    }
...
[[nodiscard]] inline SDL_GPUFillMode toSdl(FillMode mode) noexcept
{
    switch (mode)
    {
    case FillMode::Solid: return SDL_GPU_FILLMODE_FILL;
    case FillMode::Wireframe: return SDL_GPU_FILLMODE_LINE;
    }
...
[[nodiscard]] inline SDL_GPUFrontFace toSdl(FrontFace face) noexcept
{
    switch (face)
    {
    case FrontFace::CounterClockwise: return SDL_GPU_FRONTFACE_COUNTER_CLOCKWISE;
    case FrontFace::Clockwise: return SDL_GPU_FRONTFACE_CLOCKWISE;
    }
...
[[nodiscard]] inline SDL_GPUCompareOp toSdl(CompareOp op) noexcept
{
    ...
    case CompareOp::LessOrEqual: return SDL_GPU_COMPAREOP_LESS_OR_EQUAL;
    case CompareOp::Greater: return SDL_GPU_COMPAREOP_GREATER;
    case CompareOp::NotEqual: return SDL_GPU_COMPAREOP_NOT_EQUAL;
    case CompareOp::GreaterOrEqual: return SDL_GPU_COMPAREOP_GREATER_OR_EQUAL;
...
[[nodiscard]] inline SDL_GPUSamplerMipmapMode toSdl(MipmapMode mode) noexcept
{
    switch (mode)
    {
    case MipmapMode::Nearest: return SDL_GPU_SAMPLERMIPMAPMODE_NEAREST;
    case MipmapMode::Linear: return SDL_GPU_SAMPLERMIPMAPMODE_LINEAR;
    }
...
[[nodiscard]] inline SDL_GPUVertexElementFormat toSdl(VertexFormat format) noexcept
{
    ...
    case VertexFormat::Ubyte4Unorm: return SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM;
    }
...
[[nodiscard]] inline u32 bytesPerPixel(TextureFormat format) noexcept
{
    ...
    case TextureFormat::Bc7RgbaUnorm: return 0;
    }
    return 0;
}
